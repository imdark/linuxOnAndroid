	...
	private OnClickListener btn_DownloadImage_onClick = new OnClickListener() {
		public void onClick(View v) {
			if (AppPreferences.getPrefs().getString("ANDROID", "1")
					.equals("4.3")) {
				downloadImage(v.getContext(), CFG.torrentURL_Kali_Core_ext4,
						CFG.imageURL_Kali_Core_ext4);
			} else {
				downloadImage(v.getContext(), CFG.torrentURL_Kali_Core_ext2,
						CFG.imageURL_Kali_Core_ext2);
			}
		}
	};
