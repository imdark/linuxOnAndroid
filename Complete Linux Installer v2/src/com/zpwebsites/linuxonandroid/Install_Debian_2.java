...
public class Install_Debian_2 extends SherlockFragment {
	...
	private void downloads(Context context) {
		...
		btn_DownloadLarge.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				downloadImage(v.getContext(), CFG.torrentURL_Debian_Large,
						CFG.imageURL_Debian_Large);
				dialog.dismiss();
			}
		});
		...
		btn_DownloadSmall.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				downloadImage(v.getContext(), CFG.torrentURL_Debian_Small,
						CFG.imageURL_Debian_Small);
				dialog.dismiss();
			}
		});
		...
		btn_DownloadCore.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				downloadImage(v.getContext(), CFG.torrentURL_Debian_Core,
						CFG.imageURL_Debian_Core);
				dialog.dismiss();
			}
		});
		dialog.show();
